...
func SysInfo() string {
	...
	hnos := fmt.Sprintf("Hostname: %v OS: %v(%v) %v", n.Hostname, n.Platform, n.PlatformFamily, n.PlatformVersion)
	...
	return fmt.Sprintf("%v<br/>%v<br/>%v<br/>%v<br/>%v<br/>", hnos, cpu, mem, net, disk)
}
